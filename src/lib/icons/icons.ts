export const icons = {
  ...
  "spinners-bars": {
    symbol: `<g><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".14"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".29" transform="rotate(30 12 12)"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".43" transform="rotate(60 12 12)"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".57" transform="rotate(90 12 12)"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".71" transform="rotate(120 12 12)"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" opacity=".86" transform="rotate(150 12 12)"></rect><rect width="2" height="5" x="11" y="1" fill="currentColor" transform="rotate(180 12 12)"></rect><animateTransform attributeName="transform" calcMode="discrete" dur="0.75s" repeatCount="indefinite" type="rotate" values="0 12 12;30 12 12;60 12 12;90 12 12;120 12 12;150 12 12;180 12 12;210 12 12;240 12 12;270 12 12;300 12 12;330 12 12;360 12 12"></animateTransform></g>`,
    viewBox: `0 0 24 24`,
    set: `svg`,
  },

  "arrow-undo": {
    symbol: `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="m9.97 21.25l8.26-8.26a5.999 5.999 0 0 0-8.483-8.483L5.013 9.24l-.622.622m7.199.505H5.513c-.447 0-.848-.195-1.122-.505M4.013 2.79v6.077c0 .382.143.73.378.995"></path>`,
    viewBox: `0 0 24 24`,
    set: `proicons`,
  },
  "arrow-rotate-ccw": {
    symbol: `<g fill="none" stroke="currentColor" stroke-width="1"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 12a8.25 8.25 0 1 0-12.375 7.145l1.168.503m.082-3.398v3q-.002.213-.082.398m-3.918.602h3a1 1 0 0 0 .918-.602"></path><path d="M14.5 11.75a2.25 2.25 0 1 1-4.5 0a2.25 2.25 0 0 1 4.5 0Z"></path></g>`,
    viewBox: `0 0 24 24`,
    set: `proicons`,
  },
  "arrow-right": {
    symbol: `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 12h15.879m-6.129 6.75l5.69-5.69c.292-.292.439-.676.439-1.06M13.75 5.25l5.69 5.69c.292.292.439.676.439 1.06"></path>`,
    viewBox: `0 0 24 24`,
    set: `proicons`,
  },
  clear: {
    symbol: `<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="m5 19l7-7m0 0l7-7m-7 7L5 5m7 7l7 7"></path>`,
    viewBox: `0 0 24 24`,
    set: `proicons`,
  },
  "g-claws": {
    symbol: `<path fill="currentColor" d="M229.832 24.166C169.087 23.868 108.817 50.45 68.12 101.72c-70.4 88.68-55.578 217.634 33.1 288.032a174 174 0 0 0 4.26 3.27c.286.303.575.618.86.916c-.118-.177-.23-.355-.348-.532c5.055 3.744 10.36 7.29 15.504 10.475a204.3 204.3 0 0 1-36.783-50.52c-26.065-64.267-15.236-129.285 32.96-161.24c58.434-38.76 151.118-15.176 215.06 51.675c-3.942-5.902-8.413-12.113-13.016-17.834c-63.682-79.235-166.368-109.6-229.362-67.817c-1.072.71-2.122 1.442-3.158 2.185a205.7 205.7 0 0 1 18.953-28.418c65.31-82.274 181.148-100.695 268.36-46.756c-5.63-5.66-11.95-11.454-18.358-16.54c-37.412-29.7-81.992-44.23-126.32-44.448zm160.617 82.277c45.104 42.614 67.29 102.166 63.886 161.223c-5.603 29.51-20.302 57.597-44.16 80.174c-58.436 55.31-151.12 57.978-215.063 9.238c3.944 4.784 8.413 9.73 13.016 14.145c49.375 47.45 122.196 58.87 181.786 33.818c-65.28 61.195-164.122 72.983-242.467 27.83c5.804 5.48 12.3 11.075 18.863 15.96c90.822 67.61 219.257 48.797 286.867-42.03c67.61-90.822 48.795-219.255-42.028-286.866c-6.56-4.887-13.782-9.5-20.703-13.49z"></path>`,
    viewBox: `0 0 512 512`,
    set: `game`,
  },

  "g-ace-spades": {
    symbol: `<path fill="currentColor" d="M119.436 36c-16.126 0-29.2 17.237-29.2 38.5v363c0 21.263 13.074 38.5 29.2 38.5h275.298c16.126 0 29.198-17.237 29.198-38.5v-363c0-21.263-13.072-38.5-29.198-38.5zm26.654 8.047s46.338 33.838 47.271 63.068c.776 24.287-25.024 32.122-40.775 18.586l13.633 32.653h-40.117l13.613-32.635c-15.535 13.88-40.006 5.349-40.758-18.604c-.88-28.01 47.133-63.068 47.133-63.068m95.646 120.957h7.963l63.121 160.834q3.804 9.747 15.573 9.748h5.468v8.916h-70.134v-8.916h5.587q10.936 0 15.454-2.377q3.09-1.664 3.09-5.111q0-2.02-.833-4.28l-14.62-37.326h-69.423l-8.2 21.397q-3.21 8.559-3.21 13.55q0 5.826 5.348 9.987q5.468 4.16 15.81 4.16h5.944v8.916h-63.715v-8.916q10.223 0 16.166-4.399q5.945-4.516 10.938-16.998zm-3.447 33.879l-31.502 78.338h62.17zm107.49 154.765h40.116l-13.633 32.653c15.75-13.536 41.551-5.701 40.775 18.586c-.933 29.23-47.27 63.068-47.27 63.068s-48.011-35.058-47.132-63.068c.751-23.953 25.222-32.485 40.758-18.604z"></path>`,
    viewBox: `0 0 512 512`,
    set: `game`,
  },
  "g-ace-diamonds": {
    symbol: `<path fill="currentColor" d="M119.436 36c-16.126 0-29.2 17.237-29.2 38.5v363c0 21.263 13.074 38.5 29.2 38.5h275.298c16.126 0 29.198-17.237 29.198-38.5v-363c0-21.263-13.072-38.5-29.198-38.5zm26.884 3.717h.002l47.39 58.27l-47.39 58.286l-47.377-58.287l47.375-58.27zm96.5 125.287h7.963l63.121 160.834q3.804 9.748 15.573 9.748h5.468v8.916h-70.134v-8.916h5.587q10.936 0 15.454-2.377q3.09-1.666 3.09-5.113q0-2.02-.833-4.28l-14.62-37.324h-69.423l-8.2 21.397q-3.21 8.558-3.21 13.55q0 5.826 5.348 9.987q5.468 4.16 15.81 4.16h5.944v8.916h-63.715v-8.916q10.223 0 16.166-4.399q5.945-4.516 10.937-16.998zm-3.447 33.879l-31.502 78.336h62.17zm126.29 153.64l47.392 58.27l-47.393 58.287l-47.375-58.287z"></path>`,
    viewBox: `0 0 512 512`,
    set: `game`,
  },
  "g-money": {
